    ...
    <div class="main">
      <div class="course-info">
        <div class="wrap-left">
          ...
          />
          <img :src="course.info.course_cover" v-else style="width: 100%" alt="">
        </div>
        <div class="wrap-right">
          <h3 class="course-name">{{ course.info.name }}</h3>
          <p class="data">{{ course.info.students }}人在学&nbsp;&nbsp;&nbsp;&nbsp;课程总时长：{{ course.info.pub_lessons }}课时/{{ course.info.lessons }}小时&nbsp;&nbsp;&nbsp;&nbsp;难度：{{ course.info.get_level_display }}</p>
          <div class="sale-time">
            ...
            <div class="chapter-item" v-for="chapter in course.chapter_list">
              ...
              <ul class="lesson-list">
                <li class="lesson-item" v-for="lesson in chapter.get_lesson_list">
                  <p class="name">
                    <span class="index">{{chapter.order}}-{{lesson.order}}</span>
                    {{lesson.name}}
