  ...
  <div class="success" v-if="order.is_show">
    ...
    <div class="main">
      ...
      <div class="wechat-code">
        <img src="../assets/wechat.png" alt="" class="er">
...
order.relay_alipay_result(query_string).then(res=>{
  order.is_show = true;
  order.course_list = res.data.course_list;
  order.real_price = res.data.real_price;
  order.pay_time = res.data.pay_time;
}).catch(error=>{
  console.log(error);
})
