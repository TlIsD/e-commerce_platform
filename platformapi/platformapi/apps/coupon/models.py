...
class Coupon(BaseModel):
    ...
    sale = models.TextField(verbose_name="优惠公式", help_text="""*号开头表示折扣价，<br>-号开头表示减免价<br>""")
...
class CouponDirection(models.Model):
    ...
    class Meta:
        db_table = "ec_coupon_course_direction"
...
class CouponCourseCat(models.Model):
    ...
    class Meta:
        db_table = "ec_coupon_course_category"
...
class CouponLog(BaseModel):
    ...
    orders = models.ForeignKey(Order, null=True, blank=True, default=None, on_delete=models.CASCADE, related_name="to_coupon", verbose_name="订单", db_constraint=False)
