# Generated by Django 3.2.9 on 2025-05-06 21:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale', models.TextField(help_text='*号开头表示折扣价，<br>-号开头表示减免价<br>', verbose_name='优惠公式')),
            ],
            options={
                'verbose_name': '优惠券',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orders', models.ForeignKey(blank=True, db_constraint=False, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='to_coupon', to='orders.order', verbose_name='订单')),
